"""
B3 - Semantic Chunking / Chunking ngữ nghĩa

Input:
- JSON chunks từ B2

Output:
- Semantic chunks (~400 tokens, max ~650)

Workflow:
1. Merge small chunks (<200 tokens) vào main chunk gần nhất
2. Split oversized chunks (>650 tokens), giữ heading hierarchy
3. Add 2-sentence overlap khi split
4. Add references và ellipsis

Config:
- MIN_TOKENS: 200 (merge threshold)
- TARGET_TOKENS: 400
- MAX_TOKENS: 650
- OVERLAP_SENTENCES: 2
"""
